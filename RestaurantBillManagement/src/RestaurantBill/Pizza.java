...
public class Pizza extends JFrame 
{
	...
	private JTextField jtxtMargherita;
	private JTextField jtxtVegTrioMeal;
	private JTextField jtxtPeriPeriChicken;
	...
	public Pizza() 
	{
		...
		JLabel lblMargerita = new JLabel("Margherita");
		lblMargerita.setBounds(21, 22, 173, 29);
		lblMargerita.setFont(new Font("Tahoma", Font.PLAIN, 22));
		panel_1.add(lblMargerita);
		
		JLabel lblPeriPeri = new JLabel("Veg. Trio Meal");
		lblPeriPeri.setBounds(21, 70, 242, 29);
		lblPeriPeri.setFont(new Font("Tahoma", Font.PLAIN, 22));
		panel_1.add(lblPeriPeri);
		
		JLabel lblVegTrio = new JLabel("Peri-Peri Chicken");
		lblVegTrio.setBounds(21, 120, 173, 29);
		lblVegTrio.setFont(new Font("Tahoma", Font.PLAIN, 22));
		panel_1.add(lblVegTrio);
		
		jtxtMargherita = new JTextField();
		jtxtMargherita.setBounds(317, 22, 253, 29);
		jtxtMargherita.setHorizontalAlignment(SwingConstants.RIGHT);
		jtxtMargherita.setFont(new Font("Tahoma", Font.PLAIN, 22));
		jtxtMargherita.setColumns(10);
		panel_1.add(jtxtMargherita);
		
		jtxtVegTrioMeal = new JTextField();
		jtxtVegTrioMeal.setBounds(317, 70, 253, 29);
		jtxtVegTrioMeal.setHorizontalAlignment(SwingConstants.RIGHT);
		jtxtVegTrioMeal.setFont(new Font("Tahoma", Font.PLAIN, 22));
		panel_1.add(jtxtVegTrioMeal);
		
		jtxtPeriPeriChicken = new JTextField();
		jtxtPeriPeriChicken.setBounds(317, 120, 253, 29);
		jtxtPeriPeriChicken.setHorizontalAlignment(SwingConstants.RIGHT);
		jtxtPeriPeriChicken.setFont(new Font("Tahoma", Font.PLAIN, 22));
		jtxtPeriPeriChicken.setColumns(10);
		panel_1.add(jtxtPeriPeriChicken);
		...
		jbtnReset.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				jtxtMargherita.setText(null);
				jtxtVegTrioMeal.setText(null);
				jtxtPeriPeriChicken.setText(null);
		...
		jbtnReceipt.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				double Qty1 = Double.parseDouble(jtxtMargherita.getText());
				double Qty2 = Double.parseDouble(jtxtVegTrioMeal.getText());
				double Qty3 = Double.parseDouble(jtxtPeriPeriChicken.getText());
...
*/
		...
		jbtnTotal.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				double Margherita = Double.parseDouble(jtxtMargherita.getText());
				double iMargherita = 89.00;
				double Pizza;
				
				Pizza = (Margherita * iMargherita);
				String pMeal = String.format("%.2f", Pizza);
				jlblCostOfMeal.setText(pMeal);
				
				double VegTrioMeal = Double.parseDouble(jtxtVegTrioMeal.getText());
				double iVegTrioMeal = 149.00;
				double PizzaMeal;
				
				PizzaMeal = (VegTrioMeal * iVegTrioMeal);
				String cbMeal = String.format("%.2f", PizzaMeal + Pizza);
				jlblCostOfMeal.setText(cbMeal);
				
				double PeriPeriChicken = Double.parseDouble(jtxtPeriPeriChicken.getText());
				double iPeriPeriChicken = 184.00;
				double PeriPizzaMeal;
				
				PeriPizzaMeal = (PeriPeriChicken * iPeriPeriChicken);
				String cheese = String.format("%.2f", PeriPizzaMeal + PizzaMeal + Pizza);
